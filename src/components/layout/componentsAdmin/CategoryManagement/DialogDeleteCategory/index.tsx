...
const DialogDeleteCategory: React.FC<DialogDeleteCategoryProps> = ({ handleClose, onDeleteCategory, category }) => {
            ...
            <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-customDark3 absolute top-164 left-435 w-[569px] h-auto rounded-8">
                    <div className="h-[48px] md:px-5 py-5 rounded-tl-8 rounded-tr-8 flex items-center bg-customBlack">
                        <span className="text-lg font-sans font-semibold tracking-tight text-white">Xoá loại sản phẩm</span>
